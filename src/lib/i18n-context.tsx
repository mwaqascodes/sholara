...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'login.title': { en: 'Welcome to Scholara', ur: 'اسکولرا میں خوش آمدید' },
  'login.subtitle': { en: 'AI-Powered School Management System', ur: 'AI سے چلنے والا اسکول مینجمنٹ سسٹم' },
